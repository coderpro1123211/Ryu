...
public class FieldOfView : MonoBehaviour {
    ...
    public void DrawFieldOfView() {
		...
		for (int i = 0; i <= stepCount; i++) {
			...
			viewPoints.Add (newViewCast.point + (newViewCast.hit ? (transform.position-newViewCast.point).normalized * -maskCutawayDst : Vector3.zero));
